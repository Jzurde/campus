...
export const siteData = {
    shortDescription: '自然空白ブログサイト',
    copyright: '2024 Jzurde All right reserved.',
    profile: {
        name: 'あなたの名前',
        description: 'あなたのプロフィール。<br>少し長分でもいいかもしれませんね。'
    },
    snsLinks: {
        twitter: 'https://twitter.com/xxxx',
        bluesky: 'https://bsky.app/profile/xxx.xxx.xxx',
        github: 'https://github.com/xxxxx'
    },
    siteLogoSVGData: {
        pure: `
        <? xml version="1.0" encoding="UTF-8" ?> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 147.44 27.12">
            <g>
                <g>
